...
console.log('Using', process.env.NODE_ENV, 'config'); // eslint-disable-line
...
const cssLoaders =
  process.env.NODE_ENV === 'production'
    ...
    : [{ loader: 'style-loader', options: { sourceMap: true } }].concat(
        baseCSSLoaders
      );
...
const config = {
  ...
  entry: {
    main: ['babel-polyfill', 'react-hot-loader/patch', './javascripts/main.js']
  },
  devtool:
